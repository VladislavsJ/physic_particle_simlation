...
float Graph::findMaxValueX()
{
    return findMaxValue(m_dataX);
}
float Graph::findMinValueY() {
    return findMinValue(m_dataY);
}
float Graph::findMaxValueY() {
    return findMaxValue(m_dataY);
}
float Graph::findMinValueX() {
    return findMinValue(m_dataX);
}
